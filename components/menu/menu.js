  ...
  methods: {
    ...
    renderMenuItem: function (h, menu) {
      ...
      if (menu.meta && menu.meta.link) {
        ...
        config = {
          attrs: {
            style: 'overflow:hidden;whitewhite-space:normal;text-overflow:clip;',
            href: menu.meta.link,
            target: '_blank'
          }
        }
        ...
        [
          h(tag, config,
            [
              ...
              menu['name_' + lang] || menu.name || this.$t(getI18nKey(menu.fullPath))
            ]
          )
        ]
      )
    ...
    renderSubMenu: function (h, menu) {
      ...
      let subItem = [h('span', {
        ...
        [
          this.renderIcon(h, menu.meta ? menu.meta.icon : 'none', menu.fullPath),
          menu['name_' + this_.lang.toLowerCase()] || menu.name || this.$t(getI18nKey(menu.fullPath))
        ]
      )]
      let itemArr = []
