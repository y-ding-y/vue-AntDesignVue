        ...
        <a-list-item>
          ...
          >
            <a-select-option
              ...
              >{{
                item['alias_' + lang.toLowerCase()] || item.alias
              }}</a-select-option
            >
          </a-select>
        </a-list-item>
        <a-list-item>
          ...
          >
            <a-select-option
              ...
              >{{ $t('animate.' + item) }}</a-select-option
            >
          </a-select>
        </a-list-item>
      </a-list>
...
import navSideSvg from '@/assets/img/navigate.side.svg'
import navHeadSvg from '@/assets/img/navigate.head.svg'
import navMixSvg from '@/assets/img/navigate.mix.svg'
import themeDarkSvg from '@/assets/img/theme.dark.svg'
import themeLightSvg from '@/assets/img/theme.light.svg'
import themeNightSvg from '@/assets/img/theme.night.svg'
...
export default {
  ...
  methods: {
    ...
    saveSetting() {
      const closeMessage = this.$message.loading(this.$t('saveTip'), 0)
