module.exports = {
  messages: {
    cn: {
      ...
      reset: '重置配置',
      saveTip: '正在保存到本地，请稍后...',
      resetTip: '重置主题会刷新页面，当前页面内容不会保留，确认重置？',
    },
    tw: {
      theme: {
        title: '整體風格設置',
      ...
      reset: '重置配置',
      saveTip: '正在保存到本地，請稍後...',
      resetTip: '重置主題會刷新頁面，當前頁面內容不會保留，確認重置？',
    },
    us: {
      theme: {
      ...
      save: 'Save',
      reset: 'Reset',
      saveTip: 'Saving to local, please wait...',
      resetTip: 'Resetting the theme will refresh the page. The current page content will not be retained. Are you sure you want to reset?',
    }
  }
}